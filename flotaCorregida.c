...
int z,c,jugar, jugador_main[6][10], programa_main[6][10], opcion1_main, opcion2_main, puntajeprograma_main=0,puntajejugador_main=0;
time_t start,end;
//________________
         	...
         	case 1:
         		{
					...
					printf("Cada jugador  debe  colocar  sus barcos mediante cooordenadas(x,y) \n\n");
					printf("El turno se ira alternando, cuando te toque deberas poner las coordanadas(x,y)\n para hundir la flota del contrincante \n\n");
					printf("Buena suerte \n");
					break;
				 }
         	case 2:
